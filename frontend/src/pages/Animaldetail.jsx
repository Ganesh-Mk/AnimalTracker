    ...
    <div className="w-full max-w-6xl mx-auto py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">Detailed information about your animal</p>
        </div>
        ...
        <div className="bg-white bg-white rounded-lg shadow-md p-6 md:p-8">
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <p>Latitude: {animalData.animalLat}, Longitude: {animalData.animalLong}</p>
            </div>
            <div className="grid gap-2">
              <span className="text-sm text-gray-500 dark:text-gray-400">Total Meters</span>
              <div className="flex items-center gap-4">
                <p className="text-3xl w-[15vw] font-bold">{animalData.animalMeter} m</p>
            ...
            <div className="grid gap-2">
              <span className="text-sm text-gray-500 dark:text-gray-400">Total Kilometers</span>
              <div className="flex items-center gap-4">
                <p className="text-3xl w-[15vw] font-bold">{animalData.animalKm} km</p>
                <div className="w-[560px] aspect-[4/3]">
                  <ResponsiveBar
                    data={kmChartData}
                    keys={['kilometers']}
            ...
            <div className="grid gap-2">
              ...
              <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100">
                {animalData.animalOutside === false ? 'Inside border and Safe' : 'Outside border and not Safe'}
              </div>
            </div>
          </div>
        </div>
